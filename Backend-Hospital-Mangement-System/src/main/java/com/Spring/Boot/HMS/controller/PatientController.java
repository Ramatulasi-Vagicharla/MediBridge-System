...
public class PatientController {
	...
	@GetMapping("/patients/assignedDoctor/{assignedDoctor}")
public ResponseEntity<List<Patient>> getPatientsByDoctor(@PathVariable String assignedDoctor) {
    List<Patient> patients = patientrepo.findByAssignedDoctor(assignedDoctor);
